...
const { getComments, getComment, createComment, autorizeComment, deleteComment, getCommentsById } = require('../controllers/comment')
...
router.get('/get-comments-by-id/:id', getCommentsById)
